...
def getDictNames(list_names: list[str]) -> dict:
    ...
    for i in range(len(list_names)):
        first_name[list_names[i][0]] = colapsedNames(
            first_name, list_names, i, 0)
        middle_name[list_names[i][1]] = colapsedNames(
            middle_name, list_names, i, 1)
        last_name[list_names[i][2]] = colapsedNames(
            last_name, list_names, i, 2)
...
x = dataFrame["FirstName"]
y = dataFrame["MiddleName"]

dataFrame.plot(x='FirstName', y='MiddleName')
